...
class PertanyaanAmiUnitController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        */
        ...
        $dataPertanyaan = PertanyaanAmiUnit::with([
            ...
            'tahunAkademik'
                ...
                ->join(
                    'isi_indikator',
                    'pertanyaan_ami_unit.isi_indikator_id',
                    '=',
                    'isi_indikator.id'
                )
        ...
        */
        ...
        if ($request->ajax()) {
            ...
            return view(
                'components.pertanyaan-ami-unit.question-list',
        ...
        try {
            ...
            */
            ...
            foreach ($indikator as $item) {
                ...
                PertanyaanAmiUnit::firstOrCreate([
            ...
            return response()->json([
                'success' => true,
                'message' => 'Data pertanyaan AMI Unit berhasil disimpan.',
            ], 200);
    ...
    {
        // Ganti dari findOrFail jadi find biar ga error 404
        $data = PertanyaanAmiUnit::find($id);
        
        // Kalo data udah ga ada, tetep balikin success
        if (!$data) {
            return response()->json([
                'success' => true,
            ]);
