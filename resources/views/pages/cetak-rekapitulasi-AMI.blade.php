...
@section('title', 'Cetak Rekapitulasi AMI | SIMANTAP')

@section('content')
    <div class="flex min-h-screen flex-col">
        <x-common.page-breadcrumb pageTitle="Cetak Rekapitulasi AMI" />

        <div class="flex-1">
            <div
                class="rounded-2xl border border-gray-200 bg-white p-4 dark:border-gray-800 dark:bg-white/[0.03] sm:p-5 lg:p-6"
                x-data="cetakRekapitulasi()"
                x-init="init()"
            >
                <div class="space-y-6">
                    ...
                    <div class="rounded-xl border border-gray-200 bg-gray-50 p-4 dark:border-gray-700 dark:bg-gray-800">
                        <div class="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
                            ...
                            >
                                <a
                                    :href="'{{ route('cetak-ami.print') }}?tahun_akademik_id=' + selectedTahunId"
                                    target="_blank"
                    ...
                    >
                        Belum ada data temuan atau observasi untuk tahun akademik yang dipilih.
                    </div>
                                ...
                                <div class="border-b border-gray-200 bg-gray-50 p-4">
                                    <div class="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
                                        ...
                                        <div class="text-sm text-gray-700 lg:text-right">
                                            ...
                                            <div class="mt-1">
                                                Tanggal Terbit :
                                                <span x-text="tanggalTerbit"></span>
                                            </div>

                                            <div>
                                                No. Revisi :
                                                <span x-text="noRevisi"></span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
    ...
    function cetakRekapitulasi() {
        return {
            ...
            fetchData() {
                ...
                fetch(`{{ route('cetak-ami.data') }}?tahun_akademik_id=${this.selectedTahunId}`)
                    .then(response => {
                        if (!response.ok) {
