<header
    class="sticky top-0 flex w-full bg-white border-gray-200 z-50 dark:border-gray-800 dark:bg-gray-900 xl:border-b"
    >
    <div class="flex flex-col items-center justify-between grow xl:flex-row xl:px-6">
        <div
            ...
            <button @click="$store.header.toggleMenu()"
        ...
        <div :class="$store.header.isMenuOpen ? 'flex' : 'hidden'"
