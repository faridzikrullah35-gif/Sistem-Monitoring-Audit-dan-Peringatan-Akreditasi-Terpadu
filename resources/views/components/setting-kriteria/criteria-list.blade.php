                        ...
                        <tr>
                            <td colspan="3" class="px-6 py-12 text-center">
                                <div class="flex flex-col items-center justify-center">
                                    ...
                                    <p class="text-sm font-medium text-gray-500 dark:text-gray-400">Belum ada kriteria</p>
                                    <p class="text-xs text-gray-400 dark:text-gray-500 mt-1">Silahkan tambahkan kriteria menggunakan tombol di atas.</p>
                                </div>
                            </td>
                        </tr>
                    @endif
