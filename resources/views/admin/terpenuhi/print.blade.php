...
<head>
    ...
    <style>
        ...
        .rich-text p { margin: 0 0 4px 0; }
        .rich-text ul { list-style: disc; padding-left: 20px; margin: 4px 0; }
        .rich-text ol { list-style: decimal; padding-left: 20px; margin: 4px 0; }
        ...
        .rich-text h1, .rich-text h2, .rich-text h3 { font-weight: bold; margin: 8px 0 4px 0; }
        .rich-text h1 { font-size: 1.4em; }
        .rich-text h2 { font-size: 1.2em; }
        .rich-text h3 { font-size: 1.1em; }
        .rich-text table { width: 100%; border-collapse: collapse; margin: 4px 0; }
        .rich-text table td, .rich-text table th { border: 1px solid #000; padding: 4px 6px; }
        .rich-text table th { background-color: #f0f0f0; font-weight: bold; text-align: center; }
...
<body>
    ...
    <table class="main-table">
        ...
        <tbody>
            ...
            @empty
                <tr>
                    <td colspan="4" style="text-align:center; padding:15px;">Tidak ada data terpenuhi untuk filter yang dipilih.</td>
                </tr>
            @endforelse
        </tbody>
    </table>
